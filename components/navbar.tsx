    ...
    >
              ...
              {navItems.map((item) => {
                ...
                if (item.label === "Rewards" && user?.type === "jobseeker") {
                  return (
                    <Link
                      ...
                      className={`text-sm font-medium transition-colors hover:text-emerald-600 ${pathname === "/rewards/jobseeker" ? "text-emerald-600" : "text-gray-700"
                        }`}
                    >
                      Rewards
                    </Link>
                ...
                if (item.label === "Rewards" && user?.type === "employer") {
                  return (
                    <Link
                      ...
                      className={`text-sm font-medium transition-colors hover:text-emerald-600 ${pathname === "/rewards/employer" ? "text-emerald-600" : "text-gray-700"
                        }`}
                    >
                      Rewards
                    </Link>
                ...
                if (item.label === "Post a Job" && user?.type === "employer") {
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1 text-sm font-medium transition-colors hover:text-emerald-600 ${pathname === "/employer/post-job" ? "text-emerald-600 underline" : "text-gray-700"
                        }`}
                    >
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className={`flex items-center gap-1 text-sm font-medium transition-colors hover:text-emerald-600 ${pathname === item.href ? "text-emerald-600 underline" : "text-gray-700"
                      }`}
                  ...
                  if (item.label === "Post a Job" && user?.type === "employer") {
                    return (
                      <button
                        ...
                        disabled={isCheckingPostJobEligibility}
                        className={`flex items-center gap-1 text-sm font-medium transition-colors hover:text-emerald-600 ${pathname === "/employer/post-job" ? "text-emerald-600" : "text-gray-700"
                          }`}
                      >
                        {isCheckingPostJobEligibility ? (
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          {searchResult && (
            <div
              className={`rounded-md border px-3 py-3 text-sm ${searchResult.exists
